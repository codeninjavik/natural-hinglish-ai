    ...
    <main className="pt-24 pb-16 container mx-auto px-6 max-w-3xl">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <div className="bg-destructive/10 border border-destructive/30 rounded-xl p-5 mb-8">
          ...
          <p className="text-foreground mt-2 text-sm">MYRA AI App buy karne se pahle yeh policy dhyan se padh lein. <strong>Ek baar payment hone ke baad paisa wapis / refund nahi hoga.</strong> Yeh ek digital product hai jo turant deliver hota hai, isliye koi bhi refund ya cancellation applicable nahi hai.</p>
        </div>
        ...
        <div className="prose prose-sm max-w-none text-muted-foreground space-y-4">
          ...
          <p>MYRA AI Girlfriend App aur Source Code ki sabhi purchases <strong>final hain</strong>. Yeh ek digital product hai jo instantly deliver hota hai, isliye <strong>kisi bhi condition mein refund ya paisa wapis nahi kiya jayega</strong>.</p>
          ...
          <p>Koi bhi query ho toh humse contact karein: <strong>support@myraai.com</strong> ya Telegram: <strong>@myraaimobile</strong></p>
        </div>
      </motion.div>
    </main>
  </div>

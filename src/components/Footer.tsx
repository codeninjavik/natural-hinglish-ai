        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a href="https://instagram.com/zara_ai_mobile" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors"><Instagram className="w-5 h-5" /></a>
              ...
              <a href="https://t.me/zaraaimobile" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
